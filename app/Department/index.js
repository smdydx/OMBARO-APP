...
export default function DepartmentDashboard() {
  ...
  const quickActions = [
    { id: "dept-tasks", label: "Department Tasks", icon: Briefcase, subtitle: "Manage department activities", color: COLORS.primary },
    { id: "schedule", label: "Schedule & Planning", icon: Calendar, subtitle: "View department schedule", color: COLORS.primary },
    { id: "team", label: "Team Management", icon: Users, subtitle: "Manage team members", color: COLORS.primary },
    { id: "reports", label: "Reports & Documents", icon: FileText, subtitle: "Access department reports", color: COLORS.primary },
  ];

  const bottomNavItems = [
    { id: "home", label: "Home", icon: Home, tab: "Overview" },
    { id: "tasks", label: "Tasks", icon: Briefcase, tab: "Tasks" },
        ...
        <View style={styles.headerContent}>
          ...
          <View style={styles.searchContainer}>
            <View style={styles.searchBox}>
              ...
              <TextInput
                placeholder="Search tasks, schedule, team..."
